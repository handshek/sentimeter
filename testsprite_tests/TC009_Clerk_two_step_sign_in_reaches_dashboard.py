...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /sign-in (use navigate action to http://localhost:3000/sign-in).
        await page.goto("http://localhost:3000/sign-in")
        
        # -> Enter the test email into the email field (index 420) and click the Continue button (index 445). Use provided test credential: kai@sentimail.com.
