...
export function DemoWidget({
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      <div className="group/preview relative w-full overflow-hidden rounded-xl border border-border/60 bg-muted/20 transition-shadow duration-300 hover:shadow-lg hover:shadow-primary/5">
        ...
        <div className="relative flex items-center justify-center px-0 py-10 sm:px-4 sm:py-14">
          {kind === "emoji" && <EmojiFeedback key={instance} {...props} />}
          {kind === "thumbs" && <LikeDislike key={instance} {...props} />}
          {kind === "stars" && <StarRating key={instance} {...props} />}
        </div>
      </div>
